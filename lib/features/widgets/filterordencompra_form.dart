...
import 'filteroc_form.dart';
import 'filterprovee_form.dart';

var docUserId;

class FilterOrdenCompraScreen extends StatefulWidget {
  final nameId;
  final idUser;
  const FilterOrdenCompraScreen({
    super.key,
  ...
  @override
  State<FilterOrdenCompraScreen> createState() =>
      _FilterOrdenCompraScreenState();
}

class _FilterOrdenCompraScreenState extends State<FilterOrdenCompraScreen> {
