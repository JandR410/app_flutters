...
import 'filterclient_form.dart';
import 'filterprovee_form.dart';

var docUserId;

class FilterClienteScreen extends StatefulWidget {
  final nameId;
  final idUser;
  const FilterClienteScreen({
    super.key,
  ...
  @override
  State<FilterClienteScreen> createState() => _FilterClienteScreenScreenState();
}

class _FilterClienteScreenScreenState extends State<FilterClienteScreen> {
