...
class OrdenCompraHScreen extends StatefulWidget {
  final idKey;
  final idCollection;
  final ocTabBar;
  final idUser;
  final docUSer;
  const OrdenCompraHScreen(
      {super.key,
      required this.idKey,
  ...
  @override
  State<OrdenCompraHScreen> createState() => _OrdenCompraHScreen();
}

class _OrdenCompraHScreen extends State<OrdenCompraHScreen> {
